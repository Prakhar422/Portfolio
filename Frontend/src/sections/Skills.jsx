      ...
      {skills.map((skill, index) => {
        ...
        return (
          <motion.div
            ...
            className="group rounded-2xl border border-white/10 bg-white/[0.055] p-5 text-center backdrop-blur-xl transition hover:border-cyan-200/60 hover:bg-white/[0.09]"
          >
            <div
